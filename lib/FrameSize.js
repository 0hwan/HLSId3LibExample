...
module.exports = {
  ...
  getLyricsFrameSize: (descriptionSize, lyricsSize) => {
    const headerSize = 10;
    const encodingSize = 1;
  ...
  getPictureFrameSize: (pictureSize, mimeTypeSize, descriptionSize, useUnicodeEncoding) => {
    const headerSize = 10;
    const encodingSize = 1;
  ...
  getCommentFrameSize: (descriptionSize, textSize) => {
    const headerSize = 10;
    const encodingSize = 1;
    const languageSize = 3;
    const bomSize = 2;
  ...
  getUserStringFrameSize: (descriptionSize, valueSize) => {
    const headerSize = 10;
    const encodingSize = 1;
    const bomSize = 2;
    const descriptionUtf16Size = descriptionSize * 2;
